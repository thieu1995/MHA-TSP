# Travelling Salesman Problem using MEALPY
...
conda install -c conda-forge ffmpeg         # For saving animation as mp4 
...
![DE-TSP](results/DE-TSP-2/DE-TSP-results.gif)


**Whale Optimization Algorithm**

![WOA-TSP](results/WOA-TSP/WOA-TSP-results.gif)


**Teaching Learning-based Optimization**

![TLO-DCB](results/TLO-DCB/TLO-DCB-results.gif)
